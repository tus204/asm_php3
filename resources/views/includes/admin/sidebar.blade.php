            ...
            <div class="section-menu-left">
                <div class="box-logo">
                    <a href="index.html" id="site-logo-inner">
                        <img class="w-75" id="logo" alt="" src="{{ asset('assets/admins/images/logo/logo3.png') }}"
                            data-light="{{ asset('assets/admins/images/logo/logo3.png') }}" data-dark="{{ asset('assets/admins/images/logo/logo3.png') }}">
                    </a>
